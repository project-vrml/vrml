...
import com.vavr.func.work.core.beans.SpringContextConfigurator;
import com.vavr.func.work.core.tags.Important;
import com.vavr.func.work.metric.config.MetricConfiguration;
import com.vavr.func.work.metric.index.MetricIndex;
import com.vavr.func.work.metric.index.MetricIndexs;
import com.vavr.func.work.metric.store.MetricStore;
...
public final class Metrics {
    ...
    public static Option<Tags.ItemCase> $(MetricItem pattern, Object value) {
        ...
        return Match(pattern).option(
                API.Case(API.$(instanceOf(MetricIndex.class)), clazz -> new Tags.IndexCase(pattern, () -> value)),
